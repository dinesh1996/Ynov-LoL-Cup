...
<body>
  ...
  <div class="main">
    <div class="hipsum">
      <div class="jumbotron">
        <h1 id="hello,-world!">Les tableaux</h1>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <button type="button" class="btn btn-info" name="button"><a href="ajoutertableau.php">Ajouter un tableau</a></button><br /><br />
