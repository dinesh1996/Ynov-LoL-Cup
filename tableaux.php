...
<html lang="fr">
    ...
    <body>
        ...
        <div id="qualif" class="container">
            <h1>Tableaux des qualifications</h1><br />
            <div id="ligne1" class="row">
                <div class="col-sm-4">
                    <a href="tableaux-paris.php" alt="lycéens Paris"><img src="img/lp.png" class="img-responsive"></a>
                </div>
                <div class="col-sm-4">
                    <a href="tableaux-nantes.php" alt="lycéens Nantes"><img src="img/ln.png" class="img-responsive"></a>
                </div>
                <div class="col-sm-4">
                    <a href="tableaux-bordeaux.php" alt="lycéens Bordeaux"><img src="img/lb.png" class="img-responsive"></a>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <a href="tableaux-toulouse.php" alt="lycéens Toulouse"><img src="img/lt.png" class="img-responsive"></a>
                </div>
                <div class="col-sm-4">
                    <a href="tableaux-aixenprovence.php" alt="lycéens Aix en Provence"><img src="img/laep.png" class="img-responsive"></a>
                </div>
                <div class="col-sm-4">
                    <a href="tableaux-lyon.php" alt="lycéens Lyon"><img src="img/ll.png" class="img-responsive"></a>
                </div>
            </div>
